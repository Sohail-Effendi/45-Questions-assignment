...
let current_users = ["AUN Ali", "Ahmed Ali", "Qasim Zia", "Zain Ahmed", "Saad Ullah"];
let new_users = ["Aun Ali", "Ahmed Kami", "Qasim Murad", "Zia Ahmed", "Saad Ullah"];
new_users.forEach((new_users) => {
    if (current_users.some((currentusers) => currentusers === new_users)) {
        console.log(`${new_users}, you will need to enter a new username.`);
    }
    else {
        console.log(`${new_users}, you are available`);
    }
});
// 33.	 Ordinal Numbers: 
let numbersIn = [1, 2, 3, 4, 5, 6, 7, 8, 9];
